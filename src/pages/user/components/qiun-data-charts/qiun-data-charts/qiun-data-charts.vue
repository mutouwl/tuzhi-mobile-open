...
<script>
import uChartsMp from '@/pages/user/components/qiun-data-charts/u-charts/u-charts.js';
import cfu from '@/pages/user/components/qiun-data-charts/u-charts/config-ucharts.js';
import qiunError from '@/pages/user/components/qiun-data-charts/qiun-error/qiun-error.vue';
// #ifdef APP-VUE || H5
import cfe from '@/pages/user/components/qiun-data-charts/u-charts/config-echarts.js';
// #endif
...
import uChartsRD from '@/pages/user/components/qiun-data-charts/u-charts/u-charts.js';
import cfu from '@/pages/user/components/qiun-data-charts/u-charts/config-ucharts.js';
import cfe from '@/pages/user/components/qiun-data-charts/u-charts/config-echarts.js';
