<template>
    <div>
        ...
        <view class="box control-box h5-bottom-bar" v-if="type == 'control'">
            <template>
        ...
        <view class="box h5-bottom-bar" v-if="type == 'order'">
        ...
        <view class="box h5-bottom-bar" v-if="type == 'submit'">
            <template>
                <div class="price">
        ...
        <view class="box h5-bottom-bar" v-if="type == 'evaluate'">
            <template>
                <u-button :customStyle="{ width: '100%' }" :disabled="disabled" class="custom-style" type="primary"
        ...
        <view class="box h5-bottom-bar" v-if="type == ''">
            <template>
                <u-button :customStyle="{ width: '100%' }" :disabled="disabled" class="custom-style" type="primary"
                    :text="btnTitle ? btnTitle : '立即评价'" @click="handle"></u-button>
            </template>
