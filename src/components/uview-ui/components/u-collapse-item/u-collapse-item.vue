<template>
	<view class="u-collapse-item">
		<u-cell
			...
			@click="clickHandler"
			:arrowDirection="expanded ? 'down' : 'right'"
			:disabled="disabled"
			customStyle="border-radius: 6px;background-color:#f9f9f9;padding: 5px 0px;margin:5px 0"
		>
			<!-- #ifndef MP-WEIXIN -->
		...
		>
			<view
				class="u-collapse-item__content__text content-class" style="padding-top: 0px;"
				:id="elId"
				:ref="elId"
			><slot /></view>
		</view>
