			...
			<slot>
				...
				<view class="u-action-sheet__item-wrap">
					<template v-for="(item, index) in actions">
						<!-- #ifdef MP -->
						<button :key="index" class="u-reset-button" :openType="item.openType" @getuserinfo="onGetUserInfo"
							@contact="onContact" @getphonenumber="onGetPhoneNumber" @error="onError"
							...
							style="background:none" custom-style="background:none"
							:app-parameter="appParameter" @tap="selectHandler(index)"
						...
						<!-- #endif -->
						<u-line color="#F0F3F5" v-if="index != (actions.length - 1)"></u-line>
					</template>
				</view>
			</slot>
			<u-gap bgColor="#F0F3F5" height="10" v-if="cancelText"></u-gap>
...
$u-action-sheet-title-font-size: 14px !default;
$u-action-sheet-title-padding: 12px 30px 12px 15px !default;
...
$u-action-sheet-item-wrap-item-padding: 20px 15px !default;
$u-action-sheet-item-wrap-name-font-size: 16px !default;
$u-action-sheet-item-wrap-subname-font-size: 12px !default;
$u-action-sheet-item-wrap-subname-color: #c0c4cc !default;
$u-action-sheet-item-wrap-subname-margin-top: 8px !default;
