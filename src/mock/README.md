...
node tools/mock-crawler/index.js \
  --base-url=http://tuzhi.mutouweb.com \
  --uniacid=1 \
  --auth-token=xxx
```
...
```javascript
mock.normalizeRoute(
  'http://tuzhi.mutouweb.com/index.php?i=1&route=api/app/course/index',
  'http://tuzhi.mutouweb.com/index.php?i=1&route=api/'
);
// => 'app/course/index'
```
...
```bash
node tools/mock-crawler/index.js --base-url=http://tuzhi.mutouweb.com --uniacid=1
```
